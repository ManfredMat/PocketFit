...
const Day = (props) => {
  ...
  return (
    <div>
      <WeekDayContainer>
        <p style={{ marginLeft: "1rem" }}>{props.day}</p>
      ...
      <BlockContainer block="1">
        <ExcerciseContainer>
          ...
          {props.weekChanges[props.api] ? (
            <RoundsContainer>
              Rounds: {props.weekChanges[props.api].blocks.block1.rounds}
            </RoundsContainer>
          ) : null}
        </ExcerciseContainer>
      </BlockContainer>
      ...
      <BlockContainer block="2">
        <ExcerciseContainer>
          ...
          {props.weekChanges[props.api] ? (
            <RoundsContainer>
              Rounds: {props.weekChanges[props.api].blocks.block2.rounds}
            </RoundsContainer>
          ) : null}
        </ExcerciseContainer>
      </BlockContainer>
      ...
      <BlockContainer block="3">
        <ExcerciseContainer>
          ...
          {props.weekChanges[props.api] ? (
            <RoundsContainer>
              Rounds: {props.weekChanges[props.api].blocks.block3.rounds}
            </RoundsContainer>
          ) : null}
        </ExcerciseContainer>
      </BlockContainer>
